...
import photopicker.baseadapterlib.CCROnRVItemClickListener;
import photopicker.baseadapterlib.CCRRecyclerViewAdapter;
import photopicker.baseadapterlib.CCRRecyclerViewHolder;
...
public class CCRSortableNinePhotoLayout extends RecyclerView implements CCROnItemChildClickListener, CCROnRVItemClickListener {
    ...
    private void afterInitDefaultAndCustomAttrs() {
        ...
        addItemDecoration(CCRGridDivider.newInstanceWithSpacePx(mItemWhiteSpacing / 2));
    ...
    private class ItemTouchHelperCallback extends ItemTouchHelper.Callback {
        ...
        public boolean onMove(RecyclerView recyclerView, ViewHolder source, ViewHolder target) {
            ...
            if (mDelegate != null) {
                mDelegate.onNinePhotoItemExchanged(CCRSortableNinePhotoLayout.this, source.getAdapterPosition(), target.getAdapterPosition(), getData());
            }
            return true;
        }
    ...
    public interface Delegate {
        ...
        void onNinePhotoItemExchanged(CCRSortableNinePhotoLayout sortableNinePhotoLayout, int fromPosition, int toPosition, ArrayList<String> models);
    }
}