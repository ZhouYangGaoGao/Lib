...
public final class PictureSelector {
    ...
    public PictureSelectionModel openGallery(int chooseMode) {
        return new PictureSelectionModel(this, chooseMode).loadImageEngine(GlideEngine.createGlideEngine());
    }
    ...
    public void externalPictureVideo(String path) {
        if (!DoubleUtils.isFastDoubleClick()) {
            Intent intent = new Intent(getActivity(), PicturePlayVideoActivity.class);
