...
package photopicker.baseadapterlib;
 ...
 * 描述:RecyclerView 分隔线
 */
public class CCRDivider extends RecyclerView.ItemDecoration {
    ...
    private CCRDivider(@DrawableRes int drawableResId) {
        mDividerDrawable = ContextCompat.getDrawable(CCRBaseAdapterUtil.getApp(), drawableResId);
     ...
     * @return
     */
    public static CCRDivider newDrawableDivider(@DrawableRes int drawableResId) {
        return new CCRDivider(drawableResId);
    }
     ...
     * @return
     */
    public static CCRDivider newShapeDivider() {
        return new CCRDivider(R.drawable.bga_baseadapter_divider_shape);
    }
     ...
     * @return
     */
    public static CCRDivider newBitmapDivider() {
        return new CCRDivider(R.mipmap.bga_baseadapter_divider_bitmap);
    }
     ...
     * @return
     */
    public CCRDivider setDelegate(Delegate delegate) {
        mDelegate = delegate;
        return this;
    }
     ...
     * @return
     */
    public CCRDivider setBothMarginResource(@DimenRes int resId) {
        mMarginLeft = CCRBaseAdapterUtil.getDimensionPixelOffset(resId);
     ...
     * @return
     */
    public CCRDivider setBothMarginDp(int bothMarginDp) {
        mMarginLeft = CCRBaseAdapterUtil.dp2px(bothMarginDp);
        mMarginRight = mMarginLeft;
        return this;
    }
     ...
     * @return
     */
    public CCRDivider setBothMarginPx(int bothMarginPx) {
     ...
     * @return
     */
    public CCRDivider setMarginLeftResource(@DimenRes int resId) {
        mMarginLeft = CCRBaseAdapterUtil.getDimensionPixelOffset(resId);
        return this;
    }
     ...
     * @return
     */
    public CCRDivider setMarginLeftDp(int marginLeftDp) {
        mMarginLeft = CCRBaseAdapterUtil.dp2px(marginLeftDp);
        return this;
    }
     ...
     * @return
     */
    public CCRDivider setMarginLeftPx(int marginLeftPx) {
     ...
     * @return
     */
    public CCRDivider setMarginRightResource(@DimenRes int resId) {
        mMarginRight = CCRBaseAdapterUtil.getDimensionPixelOffset(resId);
        return this;
    }
     ...
     * @return
     */
    public CCRDivider setMarginRightDp(int marginRightDp) {
        mMarginRight = CCRBaseAdapterUtil.dp2px(marginRightDp);
        return this;
    }
     ...
     * @return
     */
    public CCRDivider setMarginRightPx(int marginRightPx) {
     ...
     * @return
     */
    public CCRDivider setColorResource(@ColorRes int resId, boolean isSrcTop) {
        return setColor(CCRBaseAdapterUtil.getColor(resId), isSrcTop);
    }
     ...
     * @return
     */
    public CCRDivider setColor(@ColorInt int color, boolean isSrcTop) {
     ...
     * @return
     */
    public CCRDivider setHorizontal() {
     ...
     * @return
     */
    public CCRDivider rotateDivider() {
        if (mDividerDrawable != null && mDividerDrawable instanceof BitmapDrawable) {
            mDividerDrawable = CCRBaseAdapterUtil.rotateBitmap(((BitmapDrawable) mDividerDrawable).getBitmap());
        }
        return this;
    }
     ...
     * @return
     */
    public CCRDivider setStartSkipCount(@IntRange(from = 0) int startSkipCount) {
     ...
     * @return
     */
    public CCRDivider setEndSkipCount(@IntRange(from = 0) int endSkipCount) {
     ...
     * @return
     */
    public CCRDivider setSizeResource(@DimenRes int resId) {
        mSize = CCRBaseAdapterUtil.getDimensionPixelOffset(resId);
        return this;
    }
     ...
     * @return
     */
    public CCRDivider setSizeDp(int sizeDp) {
        mSize = CCRBaseAdapterUtil.dp2px(sizeDp);
        return this;
    }
     ...
     * @return
     */
    public CCRDivider setSizePx(int sizePx) {
        mSize = sizePx;
        return this;
    }
    ...
    private CCRHeaderAndFooterAdapter getHeaderAndFooterAdapter(RecyclerView parent) {
        RecyclerView.Adapter adapter = parent.getAdapter();
        if (adapter instanceof CCRHeaderAndFooterAdapter) {
            return (CCRHeaderAndFooterAdapter) adapter;
        } else {
            return null;
        }
    }

    private boolean isNeedSkip(int childAdapterPosition, CCRHeaderAndFooterAdapter headerAndFooterAdapter, int realChildAdapterPosition, int realItemCount) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        CCRHeaderAndFooterAdapter headerAndFooterAdapter = getHeaderAndFooterAdapter(parent);
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent, CCRHeaderAndFooterAdapter headerAndFooterAdapter, int itemCount, int realItemCount, boolean
            isDrawOver) {
    ...
    private int getRealChildAdapterPosition(int childAdapterPosition, CCRHeaderAndFooterAdapter headerAndFooterAdapter) {
        if (headerAndFooterAdapter != null) {
            // 转换成真实 item 的索引
    ...
    public interface Delegate {
        ...
        void getItemOffsets(CCRDivider divider, int position, int itemCount, Rect outRect);

        void drawVertical(CCRDivider divider, Canvas canvas, int dividerLeft, int dividerRight, int dividerBottom, int position, int itemCount);

        void drawOverVertical(CCRDivider divider, Canvas canvas, int dividerLeft, int dividerRight, int dividerBottom, int position, int itemCount);
    }
    ...
    public static class SimpleDelegate implements Delegate {
        ...
        @Override
        public void getItemOffsets(CCRDivider divider, int position, int itemCount, Rect outRect) {
        }

        @Override
        public void drawVertical(CCRDivider divider, Canvas canvas, int dividerLeft, int dividerRight, int dividerBottom, int position, int itemCount) {
        }

        @Override
        public void drawOverVertical(CCRDivider divider, Canvas canvas, int dividerLeft, int dividerRight, int dividerBottom, int position, int itemCount) {
        }
    }
    ...
    public static abstract class StickyDelegate extends SimpleDelegate {
        ...
        protected void initAttr() {
            ...
            mCategoryPaddingLeft = CCRBaseAdapterUtil.dp2px(16);
            mCategoryTextSize = CCRBaseAdapterUtil.sp2px(14);
            mCategoryHeight = CCRBaseAdapterUtil.dp2px(32);
         ...
         * 绘制悬浮分类
         */
        protected void drawOverCategory(CCRDivider divider, Canvas canvas, int dividerLeft, int dividerRight, int dividerBottom, String category) {
         ...
         * 绘制普通分类
         */
        protected void drawCategory(CCRDivider divider, Canvas canvas, int dividerLeft, int dividerRight, int dividerBottom, String category) {
            // 绘制背景
