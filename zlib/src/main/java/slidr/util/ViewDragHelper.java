...
public class ViewDragHelper {
    ...
    public static abstract class Callback {
         ...
         * The default api does not allow horizontal motion; the extending
         ...
         * The default api does not allow vertical motion; the extending
         * class must override this method and provide the desired clamping.
         *
         * @param child Child view being dragged
     ...
     * This will allow VDH to use internal compatibility apis for different
     * platform versions.
     *
     ...
     * as needed before returning. The parent view's onTouchEvent api should call this.
     *
