...
public class ShadowLayout extends FrameLayout {
    ...
    private final static float DEFAULT_SHADOW_RADIUS = 15.0F;
    private final static float DEFAULT_SHADOW_DISTANCE = 0.0F;
    private final static float DEFAULT_SHADOW_ANGLE = 45F;
    private final static int DEFAULT_SHADOW_COLOR = 0x33aaaaaa;
