...
public class CardView extends FrameLayout {
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mStartColor = a.getColor(R.styleable.CardView_cardStartColor, getResources().getColor(R.color.clo_card_shadow_start));
        mEndColor = a.getColor(R.styleable.CardView_cardEndColor, getResources().getColor(R.color.clo_card_shadow_end));
        a.recycle();
