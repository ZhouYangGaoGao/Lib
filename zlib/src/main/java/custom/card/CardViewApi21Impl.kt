...
//        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    ...
    override fun updatePadding(cardView: CardViewDelegate) {
        ...
        val hPadding = Math.ceil(RoundRectDrawableWithShadow.calculateHorizontalPadding(elevation, radius, cardView.preventCornerOverlap).toDouble()).toInt()
        val vPadding = Math.ceil(RoundRectDrawableWithShadow.calculateVerticalPadding(elevation, radius, cardView.preventCornerOverlap).toDouble()).toInt()
