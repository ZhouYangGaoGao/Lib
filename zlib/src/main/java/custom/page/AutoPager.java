...
public class AutoPager extends RelativeLayout {
    ...
    public AutoPager(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public AutoPager setPageMargin(int multiWidth, int pageMargin) {
    ...
    public AutoPager addPageTransformer(ViewPager2.PageTransformer transformer) {
        compositePageTransformer.addTransformer(transformer);
        return this;
    }

    public AutoPager setAutoTurningTime(long autoTurningTime) {
    ...
    public AutoPager setOffscreenPageLimit(int limit) {
     ...
     * 设置viewpager2的切换时长
     */
    public AutoPager setPagerScrollDuration(long pagerScrollDuration) {
     ...
     */
    public AutoPager setOrientation(@ViewPager2.Orientation int orientation) {
        viewPager2.setOrientation(orientation);
        return this;
    }

    public AutoPager addItemDecoration(@NonNull RecyclerView.ItemDecoration decor) {
        viewPager2.addItemDecoration(decor);
        return this;
    }

    public AutoPager addItemDecoration(@NonNull RecyclerView.ItemDecoration decor, int index) {
     ...
     * 是否自动轮播 大于1页轮播才生效
     */
    public AutoPager setAutoPlay(boolean autoPlay) {
        isAutoPlay = autoPlay;
    ...
    public AutoPager setIndicator(Indicator indicator) {
     ...
     */
    public AutoPager setIndicator(Indicator indicator, boolean attachToRoot) {
    ...
    public AutoPager setRoundCorners(final float radius) {
