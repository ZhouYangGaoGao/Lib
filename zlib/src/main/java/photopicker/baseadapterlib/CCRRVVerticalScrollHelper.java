 ...
 */
public class CCRRVVerticalScrollHelper extends RecyclerView.OnScrollListener {
    ...
    public static CCRRVVerticalScrollHelper newInstance(RecyclerView recyclerView) {
        return new CCRRVVerticalScrollHelper(recyclerView, null);
    }

    public static CCRRVVerticalScrollHelper newInstance(RecyclerView recyclerView, Delegate delegate) {
        return new CCRRVVerticalScrollHelper(recyclerView, delegate);
    }

    private CCRRVVerticalScrollHelper(RecyclerView recyclerView, Delegate delegate) {
