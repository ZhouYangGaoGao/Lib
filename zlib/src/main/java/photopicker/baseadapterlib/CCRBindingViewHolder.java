 ...
 * 描述:
 */
public class CCRBindingViewHolder<B extends ViewDataBinding> extends RecyclerView.ViewHolder {
    private B mBinding;
    protected CCRBindingRecyclerViewAdapter mBindingRecyclerViewAdapter;

    public CCRBindingViewHolder(CCRBindingRecyclerViewAdapter bindingRecyclerViewAdapter, B binding) {
