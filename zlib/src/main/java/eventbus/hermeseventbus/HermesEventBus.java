...
package eventbus.hermeseventbus;
...
public class HermesEventBus {
    ...
    private eventbus.hermes.HermesListener hermesListener;
    ...
    public void setHermesListener(eventbus.hermes.HermesListener hermesListener){
    ...
    public class HermesListener extends eventbus.hermes.HermesListener {
