...
public class CCRPhotoPickerPreviewActivity extends CCRPPToolbarActivity implements PhotoViewAttacher.OnViewTapListener, CCRPhotoPageAdapter.LongClickListener {
    ...
    public static class IntentBuilder {
        ...
        public IntentBuilder(Context context) {
            mIntent = new Intent(context, CCRPhotoPickerPreviewActivity.class);
        }
    ...
    protected void setListener() {
        mChooseTv.setOnClickListener(new CCROnNoDoubleClickListener() {
            @Override
    ...
    protected void processLogic(Bundle savedInstanceState) {
        ...
        if (TextUtils.isEmpty(previewPhotos.get(0))) {
            // 从CCRPhotoPickerActivity跳转过来时，如果有开启拍照功能，则第0项为""
